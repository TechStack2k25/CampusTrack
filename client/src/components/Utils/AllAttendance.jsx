          ...
          {courses.map((course) => {
            ...
            return (
              <div
                ...
                className='bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 border shadow-md rounded-lg p-6 hover:shadow-lg transition duration-300 transform hover:-translate-y-1'
              >
                <div className='flex justify-between items-center mb-2'>
                  ...
                  <span className='text-gray-700 text-sm dark:text-gray-400'>
                    {course?.attendance} / {course?.total_classes}
                  </span>
                </div>
