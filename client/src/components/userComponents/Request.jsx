          ...
          {user && user?.role === 'User' && (
            <>
              ...
              <div className='flex flex-col'>
                <label
                  htmlFor='CollegeId'
                  className='text-sm font-medium text-gray-600 dark:text-gray-400 tracking-tight'
                >
                  College Id:
                </label>
                <input
                  ...
                  type='text'
                  className={`mt-2 p-3 border rounded-lg focus:outline-none focus:ring-2 ${
              ...
              <div className='flex flex-col'>
                ...
                <select
                  ...
                  className={`cursor-pointer mt-2 p-3 border rounded-lg focus:outline-none focus:ring-2 ${
                ...
                >
                  ...
                  {user && user?.role === 'User' && (
                    <>
                      ...
                      <option value='faculty' className='cursor-pointer'>
                        Faculty
                      </option>
                    </>
                  )}
                  {user && user?.role === 'faculty' && (
                    <option value='HOD' className='cursor-pointer'>
                      HOD
                    </option>
                  )}
                </select>
                ...
                {allCourses &&
                  allCourses?.map((course) => (
                    <option key={course?._id} value={course?._id}>{`${
                      course?.name
                    } (${course?.coursecode?.toUpperCase()})`}</option>
                  ))}
              </select>
              {errors.course_id && (
                <p className='text-xs text-red-500 mt-1'>
