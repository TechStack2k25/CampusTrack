...
const DashboardContent = () => {
  ...
  return (
    <main className='flex-1 p-6'>
      <h2 className='dark:text-white text-center text-2xl font-bold mb-8 shadow'>
        ...
        <div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8'>
            ...
            <div className='bg-white shadow-md rounded p-4 border-gray-200 dark:bg-gray-900 dark:border-gray-700 border'>
              <h3 className='text-xl font-semibold tracking-tight text-gray-900 dark:text-white mb-2'>
                Courses
              </h3>
              <p className='text-sm text-gray-600 dark:text-gray-400'>
                View your active and completed courses.
              </p>
              <Link
                to={'/courses'}
      ...
      {userDashboard?.recent_event?.length > 0 ? (
        ...
        <EmptyDashboard
          features={role === 'User' ? userFeatures : studentFeatures}
        />
      )}
