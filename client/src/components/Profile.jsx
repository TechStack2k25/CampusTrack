    ...
    return (
        <div className="flex-1 p-6">
            <div className="max-w-md mx-auto mt-10 p-6 border dark:border-gray-800 shadow-lg rounded-lg">
                ...
                {/* Edit Profile Form */}
                {user ? <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                />
                    ...
                    {user.role === 'Student' && <>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-600 tracking-tight dark:text-gray-400">Year:</label>
                            <input
                                type="number"
                                value={user?.year || 1}
                                disabled={true}
