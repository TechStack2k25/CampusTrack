  ...
  return (
    <div className='flex-1 p-6 min-h-screen'>
      ...
      <div className='p-6 shadow-lg rounded mb-6 max-w-md mx-auto border dark:border-gray-700 dark:bg-black dark:bg-opacity-15'>
        <div className='mb-2'>
          <label className='block font-medium mb-1 tracking-tight dark:text-gray-400'>
            Course:
          </label>
          <select
            onChange={(e) => setCourse(e.target.value)}
            className='w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-200 dark:text-gray-700'
          >
        ...
        {assignments &&
          ...
          assignments.map((data) => {
            ...
            return (
              <div
                key={assignment?._id}
                className='bg-white dark:bg-black dark:bg-opacity-20 p-6 shadow-lg rounded-lg mb-6 border dark:border-gray-800'
              >
                <h2 className='text-xl font-bold text-gray-800 dark:text-gray-200'>
                  <span className='text-gray-600 dark:text-gray-400 font-semibold tracking-tight'>
                    Title:{' '}
                  </span>
                  {assignment.title}
                </h2>
                ...
                {students?.length > 0 ? (
                    ...
                    {students.map((student) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {student?.file && student.file.length > 0 && (
                            <a
                              href={student.file}
                              target='_blank'
                  ...
                  <p className='text-center text-gray-600 dark:text-white font-semibold my-2'>
                    No Submissions yet!
                  </p>
                )}
              </div>
