    ...
    <div className="flex-1 p-6 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        <div className="bg-white dark:bg-black dark:bg-opacity-30 dark:border dark:border-gray-700 p-4 shadow rounded-lg">
          ...
          <p className="text-4xl font-semibold text-blue-500">{userDashboard?.total_student_dep|| "No data to show!"}</p>
        </div>
        <div className="bg-white dark:bg-black dark:bg-opacity-30 dark:border dark:border-gray-700 p-4 shadow rounded-lg">
          <h2 className="text-lg font-bold text-gray-700 dark:text-gray-300">Total Faculty</h2>
          <p className="text-4xl font-semibold text-green-500">{userDashboard?.total_faculty_dep || "No Data to show!"}</p>
        </div>
      </div>
      }
