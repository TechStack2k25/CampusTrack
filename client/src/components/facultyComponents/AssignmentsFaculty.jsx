      ...
      {openForm ? (
        ...
        <div>
          <div
            ...
            className='animate-bounce cursor-pointer fixed bottom-8 right-8 text-white  font-bold text-4xl bg-blue-500 hover:bg-indigo-700 transition-all duration-250 h-12 text-center aspect-square rounded-xl'
          >
            +
          </div>
