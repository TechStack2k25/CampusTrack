  ...
  return (
    <div className='flex-1 p-6 min-h-screen'>
      ...
      {degreeTodelete && (
        <ConfirmModal
          text={
            'This action cannot be undone. Do you want to delete this degree?'
          }
              ...
              <div className='mb-4'>
                ...
                <input
                  ...
                  {...register('totalYears', {
                    ...
                    min: {
                      value: 1,
                      message: 'Degree duration must be at least 1 year!',
                    },
                    max: {
                      value: 5,
                      message: 'Degree duration cannot exceed 5 years!',
                    },
                  })}
                  className={`w-full px-4 py-2 border rounded ${
              ...
              <div className='mb-4'>
                ...
                <input
                  ...
                  {...register('totalSemesters', {
                    ...
                    min: {
                      value: 1,
                      message: 'Number of Semesters must be at least 1 year!',
                    },
                    max: {
                      value: 10,
                      message: 'Number of Semesters must not exceed 5 years!',
                    },
                  })}
                  className={`w-full px-4 py-2 border rounded ${
                    errors.totalSemesters ? 'border-red-500' : 'border-gray-300'
                  }`}
                />
